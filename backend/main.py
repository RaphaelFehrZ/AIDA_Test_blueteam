...
from api import assessments, cards, recon, sections, containers, folders, global_commands, search, system, credentials, websocket, workspace, pending_commands, context_documents, source_code, exports, auth, reports, timeline, notifications, templates, users, api_keys, asvs_requirements
...
app.include_router(exports.router, prefix=settings.API_V1_PREFIX, dependencies=protected)
